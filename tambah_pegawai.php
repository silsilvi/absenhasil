  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <!-- Class modal tambah pegawai -->
        <div class="box-header">
          <a href="pages/pegawai/tambah_pegawai.php" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
