...
$query = "SELECT * FROM pilihtriplek ORDER BY tanggal DESC";
...
<head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><b>DEPARTEMEN PILIH TRIPLEK</b></h1>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
		 ...
		 <br>
          ...
          <table id="pilihtriplek" class="table table-bordered table-hover">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <center>
                  <button class='btn btn-success btn-edit' style='margin-right:5px;' name='btneditpilihtriplek' data-id="<?php echo $row['no']?>" ><i class="glyphicon glyphicon-edit"></i></button>
                  <button class='btn btn-danger ' data-toggle='modal' data-target='#hapuspilihtriplek' data-href="pages/hapuspilihtriplek.php?no=<?php echo $row['no'];?>"><i class="glyphicon glyphicon-trash"></i>
                  </center>
                  </td>
                </tr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="kerja" id="formGroupExampleInput" required="true" minlength="1" maxlength="20">
                  </div>
                </div>
                <div class="form-group row">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control txtno" name="no" id="formGroupExampleInput" required="true" minlength="1" maxlength="20">
                  </div>
                </div>
              <div class="form-group row">
                  <label for="formGroupExampleInput" class="col-sm-3 col-form-label">Kerja</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control txtkerja" name="kerja" id="formGroupExampleInput" required="true" minlength="1" maxlength="20">
                  </div>
                </div>
                <div class="form-group row">
                <label for="exampleFormControlSelect1" class="col-sm-3 col-form-label">Panjang</label>
...
<?php
  ...
  if(isset($_GET['edit'])){
    $no = $_GET['no'];
    $sql = "SELECT * FROM pilihtriplek WHERE no='". $no ."'";
